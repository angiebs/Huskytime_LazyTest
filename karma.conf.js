...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'bower_components/angular-google-maps/dist/angular-google-maps.js', included: false },
      ...
      {pattern: 'bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js', included: false },
      {pattern: 'bower_components/ui-select/dist/select.min.js', included: false },
      {pattern: 'app/scripts/settings.json', included: false },
