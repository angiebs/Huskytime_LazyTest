...
function (angular,$, SearchModule) {
  ...
  SearchModule.controller('MainController',
    [
      ...
      'GoogleMapFactory',
      'IdealistaFactory',
      function ($scope,$log, $timeout, GoogleMapApi, GoogleMapFactory, IdealistaFactory) {
        //Variable Initialization
        angular.extend($scope, {
          idealista : {
            typeOfHouses : IdealistaFactory.getTypeOfHouses(),
            conditions: IdealistaFactory.getHouseConditions(),
            taxonomies: IdealistaFactory.getHouseTaxonomies()
          },
          filter : {
            typeOfHouses : [],
            condition: '',
